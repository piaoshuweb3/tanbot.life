...
const JOURNEY = [
  ...
  },
  {
    ...
    year: "归国 · 互联网",
    title: "亲手托起一个时代",
    desc: "回国踏上归途，纵身跃入互联网浪潮之巅，选择 IDC——互联网世界的「地基」作为战场。参与搭建的机房灯火通明，点亮了无数改变时代的公司，还一手打造了外国人在华最具影响力的社交平台。十一年光阴，从零到一，将公司带到旁人难以企及的维度。",
  },
  {
    icon: TrendingDown,
    year: "归零",
    title: "一夜之间，全部归零",
    desc: "因为坚持商业道德底线，拒绝同流合污，甚至被人陷害成盗窃国家资产罪。几千万资产、十一年青春，一夜之间全部归零，像一场梦，醒了就什么都没了。",
  },
  {
    icon: BookOpen,
    year: "十年挣扎",
